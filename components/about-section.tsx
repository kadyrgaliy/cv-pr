import { Bot, BarChart3, Layers, Settings2 } from 'lucide-react'
...
export function AboutSection({ data = aboutData }: AboutSectionProps) {
  return (
    <div className="space-y-8 md:space-y-10">
      {/* About Me */}
      <div>
        <h2 className="text-2xl md:text-3xl font-bold text-foreground mb-4">Біз туралы</h2>
      ...
      {/* What I'm Doing */}
      <div>
        <h3 className="text-xl md:text-2xl font-bold text-foreground mb-6">Біз не ұсынамыз</h3>
      ...
      <div>
        <h3 className="text-xl md:text-2xl font-bold text-foreground mb-6">Клиенттер пікірі</h3>
      ...
      <div>
        <h3 className="text-xl md:text-2xl font-bold text-foreground mb-6">Серіктестер</h3>
